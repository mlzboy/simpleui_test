# Generated by Django 2.1.7 on 2020-10-02 07:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='oj.Course', verbose_name='考试对应的课程')),
            ],
            options={
                'verbose_name': '考试管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classs', models.ForeignKey(on_delete=None, to='oj.Class', verbose_name='所在班级')),
            ],
            options={
                'verbose_name': '学生管理',
        ...
        migrations.AddField(
            model_name='exam',
            name='questions',
            field=models.ManyToManyField(to='oj.Question', verbose_name='试题集'),
        ),
        migrations.AddField(
            model_name='course',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='oj.Teacher', verbose_name='授课教师'),
        ),
        migrations.AddField(
            model_name='class',
            name='courses',
            field=models.ManyToManyField(to='oj.Course', verbose_name='所上课程'),
        ),
        migrations.AddField(
            model_name='answer',
            name='question',
